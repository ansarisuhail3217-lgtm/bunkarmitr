    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-3xl">
        ...
        <div className="bg-card rounded-2xl p-5 md:p-8 shadow-elevated border border-border mb-8">
          <h1 className="text-xl md:text-3xl font-extrabold text-gradient-hero mb-4">🪡 LoomLink के बारे में</h1>
          <p className="text-foreground leading-relaxed mb-4 text-sm md:text-base">
            LoomLink एक <strong>Voice-First AI Job & Service Matching Web Application</strong> है जो गोरखपुर की बनारसी साड़ी इंडस्ट्री के लिए डिज़ाइन की गई है।
          </p>
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            गोरखपुर की साड़ी इंडस्ट्री में अलग-अलग roles के लोग एक दूसरे को आसानी से नहीं ढूंढ पाते। Real-time digital matching system नहीं है। Low-literacy workers complex apps use नहीं कर पाते।
          </p>
        ...
        {/* Founder */}
        <div className="bg-card rounded-2xl p-5 md:p-8 shadow-elevated border border-border">
          ...
          <div className="flex items-start gap-3 md:gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground flex items-center gap-1 mt-0.5"><MapPin size={14} /> गोरखपुर – 273001, भारत</p>
