...
import { ROLE_LABELS, VARANASI_AREAS, UserRole } from '@/lib/types';
import { createUser, setCurrentUser, DEFAULT_LAT, DEFAULT_LNG } from '@/lib/store';
          ...
          <div className="flex justify-between mt-8">
            ...
            {step < STEPS.length - 1 ? (
              ...
              <button onClick={submit} disabled={submitting}
                className="px-6 py-2 gradient-hero text-primary-foreground text-sm font-semibold rounded-xl shadow-warm hover:scale-105 transition-transform disabled:opacity-50">
                {submitting ? 'पंजीकरण हो रहा...' : 'पंजीकरण करें'}
              </button>
            )}
          </div>
          </div>
