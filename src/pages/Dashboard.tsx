...
import { getCurrentUser, fetchJobs } from '@/lib/store';
import { ROLE_LABELS, URGENCY_LABELS, Job } from '@/lib/types';
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    fetchJobs().then((jobs) => { setAllJobs(jobs); setLoading(false); });
  }, []);
