...
const areas = ['लंका', 'मदनपुरा', 'अलईपुरा', 'चौक', 'भेलूपुर', 'लल्लापुरा', 'कज्जकपुरा', 'लोहता', 'बजरडीहा', 'सारनाथ', 'पांडेयपुर', 'सिगरा'];
...
export const mockJobs: Job[] = [
  { id: 'job_1', postedBy: 'user_3', postedByName: 'अब्दुल रहमान', roleRequired: 'karigar', description: 'बनारसी सिल्क साड़ी के लिए अनुभवी कारीगर चाहिए। कम से कम 5 साल का अनुभव होना चाहिए।', urgency: 'high', area: 'मदनपुरा', status: 'open', rateType: 'saree', rateAmount: 120, createdAt: new Date(Date.now() - 86400000).toISOString() },
  { id: 'job_2', postedBy: 'user_3', postedByName: 'अब्दुल रहमान', roleRequired: 'bana_vale', description: 'ताना बनाने के लिए बना वाले की जरूरत है। तुरंत काम शुरू करना होगा।', urgency: 'medium', area: 'अलईपुरा', status: 'open', rateType: 'dupatta', rateAmount: 30, createdAt: new Date(Date.now() - 2 * 86400000).toISOString() },
  { id: 'job_3', postedBy: 'user_3', postedByName: 'अब्दुल रहमान', roleRequired: 'cutting_machine_vale', description: 'कटिंग मशीन की जरूरत है 3 दिन के लिए।', urgency: 'low', area: 'लंका', status: 'filled', rateType: 'suit', rateAmount: 38, createdAt: new Date(Date.now() - 5 * 86400000).toISOString() },
  { id: 'job_4', postedBy: 'user_3', postedByName: 'अब्दुल रहमान', roleRequired: 'deka_vale', description: 'डेका वाले की तुरंत जरूरत है। अच्छी पेमेंट दी जाएगी।', urgency: 'high', area: 'चौक', status: 'open', rateType: 'saree', rateAmount: 100, createdAt: new Date().toISOString() },
];
